            ...
            <section className="flex flex-wrap gap-8 justify-center items-center">
                {skills.map((skill) => (
                    <article key={skill.skill} className="relative group flex justify-center items-center">
                        <button
                            className="select-none rounded-lg py-1 px-2 transition-all focus:opacity-[0.95] active:opacity-[0.95] disabled:pointer-events-none disabled:opacity-50 animate-wiggle"
                        >
                            {skill.icon}
                        </button>
