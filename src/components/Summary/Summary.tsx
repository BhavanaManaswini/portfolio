...
const Summary = () => {
    return (
        <article id="summary" className="w-full flex flex-col py-2">
            <Intro />
            <section className="py-6 flex flex-col border-b md:border-none">
                <h1 className='w-full text-2xl font-bold flex flex-col tracking-2'>
                    <span className='w-full text-center'>
                        <span className="max-h-[2.3rem] mx-2 inline-flex flex-col overflow-hidden">
                            <ul className="block animate-text-slide z-0">
                ...
                <article className='italic text-base text-center'>
