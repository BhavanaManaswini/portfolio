        ...
        <section id="intro" className={`w-full min-h-80 py-10 px-4 relative overflow-hidden ${isChecked ? '' : 'bg-[#acd5efff]'} border-2 border-dashed rounded-lg`}>
            <article className="w-full grid grid-cols-1 sm1:grid-cols-2 relative overflow-x-hidden z-10">
                ...
                <article className="w-fit h-fit relative">
                    ...
                    <div id="bullet" className="w-[100vw] absolute top-[15%] left-[85%] z-20 bg-red-500">
                        <Icons.bullet
